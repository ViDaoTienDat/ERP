        ...
        <ImageBackground source={require("../../../assets/images/logo-background.png")} resizeMode="contain" style={AppStyle.StyleHome.background}>
          ...
          <ScrollView>
            <View style={ {paddingHorizontal: 20, flex: 1}}>
              <RowContentCheckIn title={"Nhân viên"} content={userInfo?.full_name} />
              ...
              <View style={AppStyle.StyleCheckIn.boxCamera}>
                <Image resizeMode='stretch' source={imageUrl ? {uri: imageUrl} : require("../../../assets/images/image_sample.png")} style={{width: '100%', height: '100%'}}/>
              </View>

              <RowContentCheckIn title={"Văn phòng"} content={branch_name} />
              <RowContentCheckIn title={"Ca làm việc"} content={work_shift_name} />
